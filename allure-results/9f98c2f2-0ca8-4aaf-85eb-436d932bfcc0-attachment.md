...
```
Error: locator.click: Error: strict mode violation: locator('.btn.btn-primary') resolved to 2 elements:
    1) <a class="btn btn-primary" href="https://tutorialsninja.com/demo/index.php?route=account/register">Continue</a> aka getByRole('link', { name: 'Continue' })
    2) <input type="submit" value="Login" class="btn btn-primary"/> aka getByRole('button', { name: 'Login' })

Call log:
  - waiting for locator('.btn.btn-primary')
    - locator resolved to <a class="btn btn-primary" href="https://tutorialsninja.com/demo/index.php?route=common/home">Continue</a>
